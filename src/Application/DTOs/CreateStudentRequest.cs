...
public class BulkEnrollStudentItemRequestValidator : AbstractValidator<BulkEnrollStudentItemRequest>
{
...
public record BulkEnrollStudentsRequest(IReadOnlyList<BulkEnrollStudentItemRequest> Students);
...
public class BulkEnrollStudentsRequestValidator : AbstractValidator<BulkEnrollStudentsRequest>
{
    ...
    {
        RuleForEach(x => x.Students).SetValidator(new BulkEnrollStudentItemRequestValidator());
    }
}
